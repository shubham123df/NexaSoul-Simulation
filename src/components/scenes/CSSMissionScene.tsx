    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-ink px-4">
      ...
      >
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
          ...
          <p className="text-brand-sub mb-6">Make your webpage beautiful</p>

          {/* Before/After */}
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <div className="text-xs text-brand-sub mb-2">Before</div>
              <div className="bg-gray-900 rounded-xl p-4 min-h-[150px]">
                <h1 className="text-white text-lg">Hello World</h1>
                <p className="text-gray-400 text-sm">Plain text</p>
              </div>
            </div>
            <div>
              <div className="text-xs text-brand-sub mb-2">After</div>
              <motion.div
                className="bg-gradient-to-br from-brand-blue to-brand-violet rounded-xl p-4 min-h-[150px]"
          ...
          {completed && (
            ...
            >
              ...
              <div className="text-brand-lime font-bold text-xl mb-2">+150 XP</div>
              <div className="text-white mb-4">CSS Mission Complete!</div>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
